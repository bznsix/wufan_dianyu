...
class FutureTrader():
    def __init__(self,apikey='',secert=''):
        ...
        binance_spot.apiKey = apikey
        binance_spot.secret = secert
        binance_spot.timeout = 20000
    ...
    def get_dead_price(self, symbol,pos_side = 'BOTH'):
        ...
        '''
        r = binance.fapiPrivateV2GetPositionRisk()
        for item in r:
    ...
    def return_xianhuo_usdt(self):
        ...
        返回现货中有多少USDT
        '''
        r = binance_spot.fetch_balance()
        return binance_spot.fetch_balance()['USDT']['free']
